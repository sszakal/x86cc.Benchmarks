...
public static class BenchmarkBogusConfig
{
    public static Faker<CustomerOrderRoot> CreateCustomerOrderRootFaker(int? seed = null)
    {
        ...
        var fulfillmentFaker = new Faker<Fulfillment>()
            ...
            .RuleFor(f => f.EstimatedShipDate, f => f.Date.SoonOffset(10));
        ...
        var auditFaker = new Faker<AuditInfo>()
            ...
            .RuleFor(a => a.ApprovedAt, f => f.Random.Bool(0.6f) ? f.Date.RecentOffset(30) : null)
        ...
        return new Faker<CustomerOrderRoot>()
            ...
            .RuleFor(o => o.UpdatedAt, (f, o) => f.Date.BetweenOffset(o.CreatedAt, DateTimeOffset.UtcNow))
            ...
            .RuleFor(o => o.Metadata, f => new Dictionary<string, string?>
            {
                ...
                ["campaign"] = f.Random.Bool(0.4f) ? f.Commerce.Department() : null,
                ["priority"] = f.Random.Bool(0.2f) ? "high" : null
            });
    }
}
