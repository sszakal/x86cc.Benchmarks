...
public class RabbitMQBenchmark: MessageBrokerBenchmark, IAsyncDisposable
{
    private const string BenchmarkQueue = "benchmark_queue";
    private readonly RabbitMqContainer _container = new RabbitMqBuilder(new DockerImage("rabbitmq:latest")).Build();
