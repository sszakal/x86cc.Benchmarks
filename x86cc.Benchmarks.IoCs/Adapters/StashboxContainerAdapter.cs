...
namespace x86cc.Benchmarks.IoCs.Adapters
{
    public sealed class StashboxContainerAdapter : ContainerAdapterBase
    {
        ...
        public StashboxContainerAdapter()
        {
            ...
            this.proxyType1 = builder.CreateInterfaceProxyTypeWithTargetInterface(typeof(ICalculator1), [], ProxyGenerationOptions.Default);
            this.proxyType2 = builder.CreateInterfaceProxyTypeWithTargetInterface(typeof(ICalculator2), [], ProxyGenerationOptions.Default);
            this.proxyType3 = builder.CreateInterfaceProxyTypeWithTargetInterface(typeof(ICalculator3), [], ProxyGenerationOptions.Default);
        }
