...
public static class BenchmarkBogusConfig
{
    ...
    public static Faker<CustomerOrderRoot> CreateCustomerOrderRootFaker(int? seed = null)
    {
        ...
        var fulfillmentFaker = new Faker<Fulfillment>()
            ...
            .RuleFor(f => f.EstimatedShipDate, f => AsUtc(f.Date.Soon(10)));
        ...
        var auditFaker = new Faker<AuditInfo>()
            ...
            .RuleFor(a => a.ApprovedAt, f => f.Random.Bool(0.6f) ? AsUtc(f.Date.Recent(30)) : null)
        ...
        return new Faker<CustomerOrderRoot>()
            ...
            .RuleFor(o => o.CreatedAt, f => AsUtc(f.Date.Past(1)))
            .RuleFor(o => o.UpdatedAt, (f, o) => AsUtc(f.Date.Between(o.CreatedAt, DateTime.UtcNow)))
